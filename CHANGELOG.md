...
# Apache Arrow 0.12.0 (11 January 2019)
...
* ARROW-3710 - [CI/Python] Run nightly tests against pandas master
...
* ARROW-3910 - [Python] Set date\_as\_object to None as default, warn that default changing from False to True in 0.13
...
* ARROW-4233 - [Packaing] Create a Dockerfile to build source archive
