...
cdef api object pyarrow_wrap_batch(const shared_ptr[CRecordBatch]& cbatch)
...
cdef api object pyarrow_wrap_data_type(const shared_ptr[CDataType]& type)
...
cdef api object pyarrow_wrap_schema(const shared_ptr[CSchema]& type)
cdef api object pyarrow_wrap_table(const shared_ptr[CTable]& ctable)
cdef api object pyarrow_wrap_tensor(const shared_ptr[CTensor]& sp_tensor)
...
cdef api shared_ptr[CDataType] pyarrow_unwrap_data_type(object data_type)
